...
def achievement_analytics(player1, player2, player3):
    ...
    print(f"Common to all players: {unique_achievements.intersection(player1, player2, player3)}")
...
print("")
alice = create_player_achievements('alice', {'first_kill', 'level_10', 'treasure_hunter', 'speed_demon'})
bob = create_player_achievements('bob', {'first_kill', 'level_10', 'boss_slayer', 'collector'})
charlie = create_player_achievements('charlie', {'level_10', 'treasure_hunter', 'boss_slayer', 'speed_demon', 'perfectionist'})
print("")
...
# boss_slayer - collector - first_kill - level_10 - perfectionist - speed_demon - treasure_hunter